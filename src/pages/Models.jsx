...
import { getDynamicModels, PROVIDERS, MARKUP, ourPrice, savingsPercent } from '../data/models';
import { 
...
export default function Models() {
  ...
  // Keyboard shortcut listener to focus search (⌘K or /)
  useEffect(() => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pm-model-specs-grid">
                      ...
                      <div className="pm-spec-item">
                        <span className="pm-spec-label">Output Máx.</span>
